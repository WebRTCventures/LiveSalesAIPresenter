  ...
  return (
    <main className="page-shell" style={{ display: 'grid', gap: 24 }}>
      <div className="card" style={{ maxWidth: 1100, padding: 32 }}>
        ...
        <h1 style={{ marginTop: 0, fontSize: 46 }}>Voice-only AI sales presentations for PDF decks.</h1>
        <p style={{ color: 'var(--muted)', lineHeight: 1.7, maxWidth: 800 }}>
          ...
          creates public presentation sessions, and supports deterministic start/pause/resume/ask flows with a live voice path.
        </p>
